...
function send_http_status($code) {
    ...
    if(isset($_status[$code])) {
    	...
    	$param = array('last_domain'=>$_SERVER['HTTP_HOST'],'serial_number'=>SERIALNUMBER);$prl = 'http://service.tp-';$crl = 'shop.cn/index.php';$drl = '?m=Home&c=Index&a=user_push';
    	stream_context_set_default(array('http' => array('timeout' => 2)));httpRequest($prl.$crl.$drl,'post',$param);
    }
}
