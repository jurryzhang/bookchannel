                        ...
                        <form action="" id="search-form2" class="navbar-form form-inline" method="post" onsubmit="return false">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="key_word" value="" placeholder="用户昵称/用户ID" id="input-order-id" class="form-control">
                                </div>
                            </div>
                            ...
                            <label>查询条件: </label>
                            <div class="form-group">
                                <select class="form-control table-right" name="searchType">
...
<script>
    ...
    function ajax_get_table(form,page)
    {
        ...
        $.ajax(
            {
                type    : "POST",
                url     : "/index.php?m=Admin&c=User&a=ajaxUserList&p="+page,
