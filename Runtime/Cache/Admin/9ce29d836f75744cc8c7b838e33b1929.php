            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        ...
                        <?php echo ($channel["uname"]); ?>渠道充值记录列表
                    </h3>
                </div>
                <input type="hidden" id="cuid" value="<?php echo ($channel["channelid"]); ?>">
                <div class="panel-body">
                    <div class="navbar navbar-default">
                        <form action="" id="search-form2" class="navbar-form form-inline" method="post" onsubmit="return false">
                            <?php if($uid != ''): ?><input type="hidden" name="id" value="<?php echo ($uid); ?>" />
                                <?php else: ?>
                                <!--edit by dai-->
                                ...
                                <!--<div class="form-group">-->
                                    ...
                                    <!--<div class="input-group">-->
                                        <!--<input type="text" name="key_word" value="" placeholder="用户名" id="input-order-id" class="form-control">-->
                                    <!--</div>-->
                                <!--</div>-->
							...
							<input type="hidden" name="issum" value="<?php echo ($issum); ?>" />
                        </form>
                    </div>
...
<script>
    ...
    function ajax_get_table(form,page)
    {
        ...
        channelID = <?php echo ($channel['channelid']); ?>;


        $.ajax(
            {
                type    : "POST",
                url     : "/index.php?m=Admin&c=User&a=ajaxChannelPayLogListByChannleID&id="+channelID+"&p="+page,
