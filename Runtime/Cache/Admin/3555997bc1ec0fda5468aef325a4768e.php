        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <?php if(is_array($payloglist)): $i = 0; $__LIST__ = $payloglist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$paylog): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="text-center">
                            <?php if(($_COOKIE['cpid']== 0)OR($_COOKIE['permissions']== 1)): ?><a href="/User/userSearch/userid/<?php echo ($paylog['buyid']); ?>"><?php echo ($paylog["nickname"]); ?>(<?php echo ($paylog['buyid']); ?>)</a>
                        <?php else: ?>
                            <?php echo ($paylog["nickname"]); ?>(<?php echo ($paylog['buyid']); ?>)<?php endif; ?>
                        </td>
