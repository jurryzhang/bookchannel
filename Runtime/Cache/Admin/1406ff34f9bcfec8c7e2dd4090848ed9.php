            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        ...
                        <?php echo ($article["articlename"]); ?>小说销售详细列表
                    </h3>
                </div>
                        ...
                        <form action="" id="search-form2" class="navbar-form form-inline" method="post" onsubmit="return false">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="key_word" value="" placeholder="章节名" id="input-order-id" class="form-control">
                                </div>
                            </div>

                            <input type="hidden" name="id" value="<?php echo ($article["articleid"]); ?>" />
                            <input type="hidden" name="orderby1" value="chapterorder" />
...
<script>
    ...
    {
        articleid = <?php echo ($article['articleid']); ?>;
        ...
        $.ajax(
            {
                type    : "POST",
                url     : "./index.php?m=Admin&c=BookSale&a=ajaxChapterList&id="+articleid+"&p="+page,
