            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="navbar navbar-default">
                        <form action="/index.php?s=/Source/picList/" id="search-form2" class="navbar-form form-inline" method="post" onsubmit="return false">
                                ...
                                <button type="button" onclick="location.href='/index.php?s=/Source/picAdd.html'" class="btn btn-primary pull-right">
...
<script>
    ...
    function del(id,obj)
    {
        ...
        $.ajax(
        {
            url     : "/index.php?s=/Source/picDel/id/"+id,
            success : function(v)
            {
                if(v.status==1){
