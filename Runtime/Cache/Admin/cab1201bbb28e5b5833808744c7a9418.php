                    ...
                    <div class="navbar navbar-default">
                        <form action="" id="search-form2" class="navbar-form form-inline" method="post" onsubmit="return false">
                            <div class="form-group ">
                                <a href="<?php echo U('Affiche/affAdd');?>" class="btn btn-primary pull-left" >
                                    <span>添加公告</span>
                                </a>
                            </div>
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <?php if(is_array($affList)): $i = 0; $__LIST__ = $affList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr style="">
                                            ...
                                            <?php echo date('Y-m-d H:i:s',$list['addtime']);?>&nbsp;&nbsp;|&nbsp;&nbsp;
                                                <a href="javascript:void(0);" onclick="affdetail('<?php echo U('affDetail',array('id'=>$list['id']));?>',800,500)">
                                                    <?php echo ($list["title"]); ?>
                                                </a>
                                            </td>
                                            
                                            <td class="text-center">
                                                <a href="<?php echo U('affModify',array('id'=>$list['id']));?>" data-toggle="tooltip" title="" class="btn btn-info" data-original-title="修改">
                                                    <span>修改</span>
                                                </a>
                                                <a href="<?php echo U('affDel',array('id'=>$list['id']));?>" class="btn btn-info btn-del" data-toggle="tooltip" title="" data-original-title="删除">
                                                    <span>删除</span>
                                                </a>
                                            </td>
