        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <?php if(empty($commentList)): ?><p class="goods_title">抱歉暂时没有相关结果！</p>
                        <?php else: ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <?php if(is_array($commentList)): $i = 0; $__LIST__ = $commentList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td class="replyBtn" data-id="<?php echo ($list['commentid']); ?>" data-name="<?php echo ($list['name']); ?>" style="border-left: none;cursor: pointer;">
                                                <!-- onclick="reply('/index.php/Doc/commentReply/id/<?php echo ($list["commentid"]); ?>','<?php echo ($list["name"]); ?>',390,330)"-->
                                                <?php if($list['reply'] == ''): ?><i class="fa fa-comment-o"></i>
                                                    <?php else: ?>
                                                    <i class="fa fa-comment"></i><?php endif; ?>
                                                <input type="hidden" value="<?php echo ($list["reply"]); ?>" data-name="<?php echo ($list["name"]); ?>" id="reply<?php echo ($list['commentid']); ?>"/>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <?php if($list['ischeck'] == 1): ?><span class="label label-success" style="cursor: pointer;">已审核</span>
                                                    <?php else: ?>
                                                    <span class="label label-warning" style="cursor: pointer;" data-id="<?php echo ($list['commentid']); ?>"} data-arid="<?php echo ($list['articleid']); ?>">未审核</span><?php endif; ?>
                                                <span class="label label-default del-btn" style="cursor: pointer;" data-id="<?php echo ($list['commentid']); ?>">删除记录</span>
                                            </td>
...
<script>
    $('.label').click(function(){
        ...
        if(_this.hasClass('label-success')){
            ...
            var articleid=_this.attr('data-arid');
            $.ajax(
                {
                    type    : "POST",
