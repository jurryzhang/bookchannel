...
<div class="wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <?php if($_COOKIE['permissions']!= 0): ?><div class="pull-right">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        ...
                        <?php echo ($ptInfo["ptname"]); ?> 渠道充值记录列表
                    </h3>
                </div>
...
<script>
    ...
    function ajax_get_table(form,page)
    {
        ...
        ptID = <?php echo ($ptInfo['ptid']); ?>;

        $.ajax(
            {
                type    : "POST",
                url     : "./index.php?m=Admin&c=User&a=ajaxPtPayLogListByPtid&id="+ptID+"&p="+page,
