...
<?php if($ischannel == 1): ?><section class="content">
...
<?php if($ischannel == 1): ?><div class="row">
  <div class="col-md-6">
  ...
  <div class="col-md-6">
    ...
    <section class="content">
        <div class="container-fluid">
            <?php if($_COOKIE['permissions']== 1): ?><div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="navbar navbar-default">
                            <form action="" id="search-form2" class="navbar-form form-inline" method="post" onsubmit="return false">
                                    ...
                                    <!--导出记录-->
                                    <a type="submit" href="/index.php?s=/Channel/outSettlement" style="margin-left: 50px;" id="button-filter search-order" class="btn btn-primary">
                                        <i class="fa fa-sign-out"></i> 导出记录
                                    </a>


                                    <!--一键结算 -->
                                    <!-- <button type="submit" style="margin-left: 50px;" onclick="batSettlement()" id="button-filter search-order" class="btn btn-primary">
                                        <i class="fa fa-cny"></i> 一键结算
                                    </button> -->
                        ...
                        <?php if($_COOKIE['permissions']== 1): ?><div id="ajax_return"></div><?php endif; ?>
                    </div>
                </div><?php endif; ?>
