    	...
    	<div class="login-box ma_t_cm">
			<?php if(isset($message)) {?>    
      		...
      		<div class="login-box-body">
        		<h4 class="login-box-msg ver_cm">
        			<span class="glyphicon glyphicon-ok ver_cm"></span> 
        			<?php echo($message); ?>
        		</h4>
        		
          		<a href="javascript:void(0);">页面自动 
			...
			<?php }else{?>     
      		<!--处理失败-->
       		<div class="login-box-body">
        		<h4 class="login-box-msg ver_cm">
        			<span class="glyphicon glyphicon-remove ver_cm"></span> 
        			<?php echo($error); ?>
        		</h4>
          
          		<a href="javascript:void(0);">页面自动 
          			<a id="href" href="<?php echo($jumpUrl); ?>">跳转</a> 等待时间： 
          			<b id="wait">
          				<?php echo($waitSecond); ?>
          			</b>
          		</a>
	    	...
	    	<div class="margin text-center">
	        	<div class="copyright">
	            	...
	            	<a href="<?php echo U('Home/Index/Index');?>">渠道 v1.0.0</a>
	            	<br/>
	        	</div>
	    	</div>
    	</div><!-- /.login-box -->
