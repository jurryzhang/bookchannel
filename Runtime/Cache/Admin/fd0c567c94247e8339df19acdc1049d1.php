            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="navbar navbar-default">
                        <form action="/index.php?s=/Source/foucsList/" id="search-form2" class="navbar-form form-inline" method="post" onsubmit="return false">
                                ...
                                <button type="button" onclick="location.href='/index.php?s=/Source/foucsAdd.html'" class="btn btn-primary pull-right">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo ($list["pic"]); ?>" target="_blank">
                                                   <img  width="150px" src="<?php echo ($list["pic"]); ?>">
                                                </a>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <?php echo ($list["channel"]); ?>
                                            </td>


                                            <td class="text-center">
                                                    <a href="javascript:void (0)" onclick="del(<?php echo ($list["id"]); ?>,this);" id="button-delete6" data-toggle="tooltip" title="" class="btn btn-danger" data-original-title="删除渠道">
                                                        <span>删除模板</span>
                                                    </a>
                                            </td>
...
<script>
    ...
    function del(id,obj)
    {
        ...
        $.ajax(
        {
            url     : "/index.php?s=/Source/foucsDel/id/"+id,
            success : function(v)
            {
                if(v.status==1){
