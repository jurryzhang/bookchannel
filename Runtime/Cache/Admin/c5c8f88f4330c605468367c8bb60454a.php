                            ...
                            <div class="tab-pane active" id="tab_tongyong">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" value="<?php echo ($user["uname"]); ?>" class="form-control" style="width: 350px; display: inline-block" readonly />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" value="<?php echo ($user["name"]); ?>" class="form-control" style="width: 350px; display: inline-block"  readonly/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <input type="text"  value="<?php echo ($user["regtime"]); ?>"  class="form-control" style="width: 350px; display: inline-block" readonly>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <input type="text"  value="<?php echo ($user["lastlogin"]); ?>"  class="form-control" style="width: 350px; display: inline-block" readonly>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <input type="text"  value="<?php echo ($user["egold"]); ?>"  name="egold" class="input-sm">

                                                <span style="color: #F00;">
                                                    必须整数，如：12 表示增加12点小说币
                                                </span>

                                                <!--<span style="color: #F00;">-->
                                                    <!--必须整数，如：12 表示增加12点小说币，-12 表示扣除12点小说币-->
                                                <!--</span>-->
...
//        var p =/^[1-9](\d+(\.\d{1,2})?)?$/;
    ...
    function saveAction() {
        ...
        ajax_submit_form('editUserForm','<?php echo U("User/edit?is_ajax=1");?>');
    }
</script>
</body>
</html>