...
//            var_dump($channelList);die;
    ...
    public function channelBankinfo()
    {
        ...
        if(IS_POST){
            ...
            if(cookie('permissions')==1&&cookie('uid')==1){
                ...
                if($res=(cookie('uid')>0 && cookie('channelid')>0)){
    ...
    public function wxMenu()
    {
        ...
        $channelWxModel=M('distribution_channel_wx');
        //请求url地址
        $menuUrl="http://m.kyread.com/wx/createMenu/id/$channelid.html";
    ...
    public function getTokenByUrl($channelid)
    {
        ...
        $tokenUrl="http://m.kyread.com/wx/getToken/id/$channelid.html";
	...
	**/
    ...
    public function paymentInfo(){
        ...
        $channelid=I('channelid');
        $channelModel=D('Channel');
        $data=$channelModel->getPaymentInfo($time,$channelid);
        //dump($data);exit();
        $this->assign('data',$data);
        $this->display();
    }
